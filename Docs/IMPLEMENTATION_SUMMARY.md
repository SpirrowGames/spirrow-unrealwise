...
> **最終更新**: 2026-04-17 | **バージョン**: v0.9.4 (Level Lifecycle)
...
| `LevelCommands` 🆕 | 7 KB | レベル (.umap) ライフサイクル (`create_level`, `save_current_level`, `open_level`) |
...
create_level / save_current_level / open_level  → LevelCommands  🆕
