...
COMMAND_SCHEMAS = {
    ...
    "umg_layout": {
        ...
        "set_widget_slot_property": {
            "brief": "Set slot/layout properties of a CanvasPanelSlot (supports anchor presets or explicit FAnchors + LTRB offsets)",
            "params": {
                "widget_name": {"type": "str", "required": True, "desc": "Widget name"},
                "element_name": {"type": "str", "required": True, "desc": "Element name"},
                ...
                "anchor_min": {"type": "list[float]", "desc": "Explicit anchor min [x,y] in 0-1 UV space (ignored if 'anchor' preset is provided)"},
                "anchor_max": {"type": "list[float]", "desc": "Explicit anchor max [x,y] in 0-1 UV space (ignored if 'anchor' preset is provided)"},
                "offset_left": {"type": "float", "desc": "Slot offset Left (FMargin.Left) — diff-updates existing offsets"},
                "offset_top": {"type": "float", "desc": "Slot offset Top (FMargin.Top)"},
                "offset_right": {"type": "float", "desc": "Slot offset Right (FMargin.Right)"},
                "offset_bottom": {"type": "float", "desc": "Slot offset Bottom (FMargin.Bottom)"},
                "alignment": {"type": "list[float]", "desc": "Alignment [x,y]"},
                "z_order": {"type": "int", "desc": "Z-order"},
                "auto_size": {"type": "bool", "desc": "Enable auto-sizing"},
                "path": {"type": "str", "default": "/Game/UI", "desc": "Content path"},
            },
        },
